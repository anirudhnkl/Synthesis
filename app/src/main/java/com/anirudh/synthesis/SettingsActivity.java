    ...
    private void addDrawerItems() {
        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long id) {
                ...
                {
                    case 0:
                        intent = new Intent(SettingsActivity.this, NavigationDrawerActivity.class);
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        intent = new Intent(SettingsActivity.this, MyCreationsActivity.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        SettingsActivity.this.startActivity(intent);
                        break;
                    case 3:
                        intent = new Intent(SettingsActivity.this, SynthesizersActivity.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        SettingsActivity.this.startActivity(intent);
                        break;
                    case 4:
                        intent = new Intent(SettingsActivity.this, MyFriendsActivity.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        SettingsActivity.this.startActivity(intent);
                        break;
                    case 5:
